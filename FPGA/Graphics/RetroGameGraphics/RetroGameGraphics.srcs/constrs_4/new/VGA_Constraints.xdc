...
set_input_delay -clock [get_clocks VIRTUAL_clk_25MHz_prescaler] -min -add_delay 0.400 [get_ports {debugIn[*]}]
set_input_delay -clock [get_clocks VIRTUAL_clk_25MHz_prescaler] -max -add_delay 39.600 [get_ports {debugIn[*]}]
set_input_delay -clock [get_clocks VIRTUAL_clk_25MHz_prescaler] -min -add_delay 0.400 [get_ports reset]
set_input_delay -clock [get_clocks VIRTUAL_clk_25MHz_prescaler] -max -add_delay 39.600 [get_ports reset]
set_output_delay -clock [get_clocks VIRTUAL_clk_25MHz_prescaler] -min -add_delay 0.000 [get_ports {RGBout[*]}]
set_output_delay -clock [get_clocks VIRTUAL_clk_25MHz_prescaler] -max -add_delay 5.000 [get_ports {RGBout[*]}]
...
set_input_delay -clock [get_clocks VIRTUAL_clk_25MHz_prescaler] -min -add_delay 0.400 [get_ports serialClkIn]
set_input_delay -clock [get_clocks VIRTUAL_clk_25MHz_prescaler] -max -add_delay 39.600 [get_ports serialClkIn]
set_input_delay -clock [get_clocks VIRTUAL_clk_25MHz_prescaler] -min -add_delay 0.400 [get_ports serialDataIn]
set_input_delay -clock [get_clocks VIRTUAL_clk_25MHz_prescaler] -max -add_delay 39.600 [get_ports serialDataIn]
set_output_delay -clock [get_clocks VIRTUAL_clk_25MHz_prescaler] -min -add_delay 0.000 [get_ports PWMOut]
set_output_delay -clock [get_clocks VIRTUAL_clk_25MHz_prescaler] -max -add_delay 5.000 [get_ports PWMOut]
